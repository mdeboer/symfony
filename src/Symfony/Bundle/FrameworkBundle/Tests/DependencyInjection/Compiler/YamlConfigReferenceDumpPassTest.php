...
use Symfony\Bundle\FrameworkBundle\DependencyInjection\Compiler\YamlConfigReferenceDumpPass;
...
class YamlConfigReferenceDumpPassTest extends TestCase
{
    ...
    public function testProcessWithConfigDir()
    {
        ...
        $pass = new YamlConfigReferenceDumpPass($schemaFile, [
